...
$(document).on('click','#hapus_list',function(e){
  ...
  $(document).on('click','#edit_list',function(e){
   ...
   $('#form-scaner').submit(function(e){
          ...
          $.ajax({
          url:base_url+'transaksi/in/input_scaner',
          type:"post",
          data:new FormData(this),
          processData:false,
          contentType:false,
  ...
  $(document).on('click', '#close-modal-qty_scaner', function (e) {
    e.preventDefault();
    $('#modal-qty_scaner').modal('hide');
    $("#kode_scaner").focus() ;
  }); 
   ...
   $('#form-qty_scaner').submit(function(e){
          e.preventDefault(); 

          $("#error_qty_scaner").html('');
          ...
          success: function(data){
                          var hasil = JSON.parse(data);
                          if (hasil.hasil !== "sukses") {
                              $("#error_qty_scaner").html(hasil.error.qty);
                          } else {              
                              $("#qty_scaner").val('');
                              $('#list_material').load(list_material);
                              $("#modal-qty_scaner").modal('hide') ;
