...
<script type="text/javascript">
  $(document).ready(function() {
        ...
        var list_material = "<?php echo base_url() ; ?>transaksi/in/tambah/list_transaksi/"+kode ;
        var data_material = "<?php echo base_url() ; ?>transaksi/in/tambah/data_material/"+kode ;
        ...
        var list_no_bc = "<?php echo base_url() ; ?>transaksi/in/tambah/list_no_bc/"+id_material+"/"+kode_transaksi ;
        var jml_no_bc = "<?php echo base_url() ; ?>transaksi/in/tambah/jml_qty_temp_no_bc/"+id_material+"/"+kode_transaksi;
      ...
      $(document).on('click', '#browse-no_bc', function (e) {
        ...
        else
        {
          ...
          var data_no_bc = "<?php echo base_url() ; ?>transaksi/in/tambah/data_no_bc/"+id_material+"/"+no_bc ;
  ...
  $(document).on('click', '#close-modal-form_no_bc', function (e) {
   ...
   $('#form-no_bc').submit(function(e){
          ...
          $.ajax({
          url:base_url+'transaksi/in/tambah/input_no_bc',
          type:"post",
  ...
  $(document).on('click','#hapus_temp_no_bc',function(e){
      ...
      id = $(this).attr('data-id');    
        $.post(base_url+'transaksi/in/tambah/hapus_temp_no_bc',
          {
            id:$(this).attr('data-id'),
          },
          function(html){
  ...
  $(document).on('click', '#detail', function (e) {
    ...
    $.post('<?php echo base_url();?>transaksi/in/tambah/detail_qty',
      {
  ...
  $(document).on('click', '#close-modal-form_no_bc_detail', function (e) {
   ...
   $('#form_material').submit(function(e){
          ...
          $.ajax({
          url:base_url+'transaksi/in/tambah/input_material',
          type:"post",
          data:new FormData(this),
          processData:false,
          contentType:false,
    ...
    $(document).on('click','#hapus_list',function(e){
        ...
        id = $(this).attr('data-id');
        $('#materai').val('0');
          $.post(base_url+'transaksi/in/tambah/hapus_list_material',
            {
              id:$(this).attr('data-id'),
            },
            function(html){
    ...
    $.post('<?php echo base_url();?>transaksi/in/tambah/edit_list_material',
      {
        id:$(this).attr('data-id'),
      },
      function(html){
        ...
        var list_no_bc_edit = "<?php echo base_url() ; ?>transaksi/in/tambah/list_no_bc_edit/"+id_material+"/"+kode_transaksi ;
        var jml_no_bc = "<?php echo base_url() ; ?>transaksi/in/tambah/jml_qty_no_bc_edit/"+id_material+"/"+kode_transaksi;
  ...
  $(document).on('click','#hapus_no_bc_edit_list',function(e){
    ...
    qty = $(this).attr('data-qty');   
      ...
      $.post(base_url+'transaksi/in/tambah/hapus_no_bc_edit',
        {
          id:$(this).attr('data-id'),
          qty:qty,
        },
        function(html){
            ...
            var list_no_bc = "<?php echo base_url() ; ?>transaksi/in/tambah/list_no_bc_edit/"+id_material+"/"+kode_transaksi ;
            var jml_no_bc = "<?php echo base_url() ; ?>transaksi/in/tambah/jml_qty_no_bc_edit/"+id_material+"/"+kode_transaksi;
    ...
    $(document).on('click', '#browse-no_bc_edit_list', function (e) {
      ...
      kode_transaksi = $(this).attr('data-kode_transaksi') ;   
       var data_no_bc_edit = "<?php echo base_url() ; ?>transaksi/in/tambah/data_no_bc_edit_list/"+id_material+"/"+kode_transaksi ;
  ...
  $(document).on('click', '#close-modal_no_bc_edit', function (e) {
   ...
   $('#form-no_bc_edit_list').submit(function(e){
          ...
          $.ajax({
          url:base_url+'transaksi/in/tambah/input_no_bc_edit',
          type:"post",
          data:new FormData(this),
          processData:false,
          contentType:false,
   ...
   $('#form_edit_list').submit(function(e){
          ...
          $.ajax({
          url:base_url+'transaksi/in/tambah/update_list',
          type:"post",
          data:new FormData(this),
          processData:false,
          contentType:false,
  ...
  $('#form-scaner').submit(function(e){
          e.preventDefault(); 

         
          $.ajax({
          url:base_url+'transaksi/in/scaner/input_scaner',
          type:"post",
          data:new FormData(this),
          processData:false,
          contentType:false,
