                          ...
                          <tr>
                            ...
                            <td class="p-2">
                              <div class="input-group input-group-sm ">
                                ...
                                <input type="text" id="qty" name="qty" class="form-control form-control-sm" readonly style="background: transparent;">
                                <div class="input-group-append">
                  ...
                  <div class="col-md-12">
                          ...
                          <div class="col-md-12 pl-4 pr-4">
                            <div class="alert alert-warning text-center row">
                              Make sure quantity qty does not exceed
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          <form id="form-no_bc_edit_list" method="post" action="<?php echo base_url() ; ?>transaksi/out/tambah/input_no_bc_edit">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Costumize Qty</h5>              
              </div>
              <div class="modal-body">              
                  <div class="col-md-12">
