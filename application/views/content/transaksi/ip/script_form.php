...
$(document).ready(function() {
  ...
  var list_material = "<?php echo base_url() ; ?>transaksi/input_po/list_transaksi/"+kode ;
  var data_material = "<?php echo base_url() ; ?>transaksi/input_po/data_material/"+kode ;
  ...
  $(document).on('click', '#pick_material', function (e) {
   ...
   $('#form_material').submit(function(e){
          ...
          $.ajax({
          url:base_url+'transaksi/input_po/input_material',
          type:"post",
  ...
  $(document).on('click','#hapus',function(e){
          ...
          console.log(id);
          $.post('<?php echo base_url();?>transaksi/input_po/konfirmasi',
            {
              id:$(this).attr('data-id'),
            },
            function(html){
...
$(document).on('click','#hapus_list',function(e){
    ...
    id = $(this).attr('data-id');
    $('#materai').val('0');
      $.post(base_url+'transaksi/input_po/hapus_list_material',
        {
          id:$(this).attr('data-id'),
        },
        function(html){
  ...
  $("#no_bc_1").keyup(function() {
   ...
   $('#form_transaksi').submit(function(e){
          ...
          $.ajax({
          url:base_url+'transaksi/input_po/input',
          type:"post",
          data:new FormData(this),
          processData:false,
          contentType:false,
          ...
          success: function(data){
			  alert(hasil.hasil);
                          ...
                          if (hasil.hasil !== "sukses") {
                              ...
                              $("#tanggal").val('');
                              $("#tgl").val('');
                              location.href= base_url+"transaksi/input_po/tambah";
                            }
                    }
          });
  ...
  $(document).on('click','#edit_list',function(e){
          ...
          id = $(this).attr('data-id');
          console.log(id);
          $.post('<?php echo base_url();?>transaksi/input_po/edit_list_material',
            {
              id:$(this).attr('data-id'),
            },
            function(html){
   ...
   $('#form_edit_list').submit(function(e){
          ...
          $.ajax({
          url:base_url+'transaksi/input_po/update_list',
          type:"post",
          data:new FormData(this),
          processData:false,
          contentType:false,
