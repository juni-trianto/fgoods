...
<script type="text/javascript">
  $(document).ready(function() {
		...
		var view_material = "<?php echo base_url() ; ?>transaksi/ng/tambah/view_transaksi/"+kode ;
        var data_material = "<?php echo base_url() ; ?>transaksi/ng/tambah/data_material/"+kode ;
        $('#list_material').load(list_material);
		 $('#view_material').load(view_material);
        ...
        var list_no_bc = "<?php echo base_url() ; ?>transaksi/ng/tambah/list_no_bc/"+kode+"/"+kode_transaksi ;
        var jml_no_bc = "<?php echo base_url() ; ?>transaksi/ng/tambah/jml_qty_temp_no_bc/"+kode+"/"+kode_transaksi;
      ...
      $(document).on('click', '#browse-no_bc', function (e) {
        ...
        else
        {
          ...
          var data_no_bc = "<?php echo base_url() ; ?>transaksi/ng/tambah/data_no_bc/"+kode+"/"+no_bc ;
   ...
   $('#form_material').submit(function(e){
    ...
    $.post('<?php echo base_url();?>transaksi/ng/tambah/edit_list_material',
      ...
      function(html){
        ...
        var list_no_bc_edit = "<?php echo base_url() ; ?>transaksi/ng/tambah/list_no_bc_edit/"+kode+"/"+kode_transaksi ;
        var jml_no_bc = "<?php echo base_url() ; ?>transaksi/ng/tambah/jml_qty_no_bc_edit/"+kode+"/"+kode_transaksi;
  ...
  $(document).on('click','#hapus_no_bc_edit_list',function(e){
    ...
    qty = $(this).attr('data-qty');   
      ...
      $.post(base_url+'transaksi/ng/tambah/hapus_no_bc_edit',
        ...
        function(html){
            ...
            var list_no_bc = "<?php echo base_url() ; ?>transaksi/ng/tambah/list_no_bc_edit/"+kode+"/"+kode_transaksi ;
            var jml_no_bc = "<?php echo base_url() ; ?>transaksi/ng/tambah/jml_qty_no_bc_edit/"+kode+"/"+kode_transaksi;
    ...
    $(document).on('click', '#browse-no_bc_edit_list', function (e) {
      ...
      kode_transaksi = $(this).attr('data-kode_transaksi') ;   
       var data_no_bc_edit = "<?php echo base_url() ; ?>transaksi/ng/tambah/data_no_bc_edit_list/"+kode+"/"+kode_transaksi ;
