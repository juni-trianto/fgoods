        ...
        <div class="col-md-12 row">
            ...
            <div class="col-md-7 p-2" >
              ...
              <div class="col-md-12 ml-2 p-2" style="border:1px #ddd solid;">
                <form id="form-scaner" method="post" action="<?php echo base_url() ; ?>transaksi/ng/input_scaner" >
                  <table style="font-size: 13px ;width: 100%;">
                          <tr>
              ...
              <div class="modal-body">              
                  <div class="col-md-12">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-md-12">
                                  <input type="hidden" id="id_list_transaksi" name="id_list_transaksi" class="form-control">
                                  <input type="hidden" id="kode_no_bc" name="kode_no_bc" class="form-control">
                                  <input type="hidden" id="tanggal_no_bc" name="tanggal_no_bc" class="form-control">
...
<div class="modal " id="modal-form_no_bc_edit_list" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          <form id="form-no_bc_edit_list" method="post" action="<?php echo base_url() ; ?>transaksi/ng/input_no_bc_edit">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Costumize Qty</h5>              
              </div>
              <div class="modal-body">              
                  <div class="col-md-12">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-md-12">
                                  ...
                                  <input type="hidden" id="tanggal_no_bc_edit_list" name="tanggal_no_bc" class="form-control">
