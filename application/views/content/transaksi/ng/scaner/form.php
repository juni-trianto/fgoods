        ...
        <div class="col-md-12 row">
            ...
            <div class="col-md-7 p-2" >
              ...
              <div class="col-md-12 ml-2 p-2" style="border:1px #ddd solid;">
                <form id="form-scaner" method="post" action="<?php echo base_url() ; ?>transaksi/ng/scaner/input_scaner" >
                  <table style="font-size: 13px ;width: 100%;">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          <form id="form-no_bc" method="post" action="<?php echo base_url() ; ?>transaksi/ng/input_no_bc">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Cuztomize Qty</h5>              
              </div>
              <div class="modal-body">              
                  <div class="col-md-12">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          <form id="form-no_bc_detail" method="post" action="<?php echo base_url() ; ?>transaksi/ng/tambah/input_no_bc">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Coztumize Qty</h5>              
              </div>
              <div class="modal-body">              
                  <div class="col-md-12">
