...
<script type="text/javascript">
  $(document).ready(function() {
        ...
        var list_no_bc = "<?php echo base_url() ; ?>transaksi/out/tambah/list_no_bc/"+id_material+"/"+kode_transaksi ;
        var jml_no_bc = "<?php echo base_url() ; ?>transaksi/out/tambah/jml_qty_temp_no_bc/"+id_material+"/"+kode_transaksi;
      ...
      $(document).on('click', '#browse-no_bc', function (e) {
        ...
        else
        {
          ...
          var data_no_bc = "<?php echo base_url() ; ?>transaksi/out/tambah/data_no_bc/"+id_material+"/"+no_bc ;
   ...
   $('#form_material').submit(function(e){
    ...
    $.post('<?php echo base_url();?>transaksi/out/tambah/edit_list_material',
      ...
      function(html){
        ...
        var list_no_bc_edit = "<?php echo base_url() ; ?>transaksi/out/tambah/list_no_bc_edit/"+id_material+"/"+kode_transaksi ;
        var jml_no_bc = "<?php echo base_url() ; ?>transaksi/out/tambah/jml_qty_no_bc_edit/"+id_material+"/"+kode_transaksi;
  ...
  $(document).on('click','#hapus_no_bc_edit_list',function(e){
    ...
    qty = $(this).attr('data-qty');   
      ...
      $.post(base_url+'transaksi/out/tambah/hapus_no_bc_edit',
        ...
        function(html){
            ...
            var list_no_bc = "<?php echo base_url() ; ?>transaksi/out/tambah/list_no_bc_edit/"+id_material+"/"+kode_transaksi ;
            var jml_no_bc = "<?php echo base_url() ; ?>transaksi/out/tambah/jml_qty_no_bc_edit/"+id_material+"/"+kode_transaksi;
    ...
    $(document).on('click', '#browse-no_bc_edit_list', function (e) {
      ...
      kode_transaksi = $(this).attr('data-kode_transaksi') ;   
       var data_no_bc_edit = "<?php echo base_url() ; ?>transaksi/out/tambah/data_no_bc_edit_list/"+id_material+"/"+kode_transaksi ;
  ...
  $('#form-scaner').submit(function(e){
          ...
          $.ajax({
          url:base_url+'transaksi/out/scaner/input_scaner',
          type:"post",
          data:new FormData(this),
          processData:false,
          contentType:false,
