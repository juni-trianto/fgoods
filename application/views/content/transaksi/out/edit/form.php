        ...
        <div class="col-md-12 row">
            ...
            <div class="col-md-7 p-2" >
              ...
              <div class="col-md-12 ml-2 p-2" style="border:1px #ddd solid;">
                <form id="form_material" method="post" action="<?php echo base_url() ; ?>transaksi/out/tambah/input_material" >
                  <table style="font-size: 13px ;width: 100%;">
                          <tr>
                          ...
                          <tr>
                            ...
                            <td class="p-2">
                              <div class="input-group input-group-sm ">
                                ...
                                <div class="input-group-append">
                                    <button type="button" class="input-group-text text-dark" id="browse-no_bc" style="background: transparent;">Select PO Number</button>
                                </div>
                              </div>
                            </td>
                          </tr>
        ...
        <div class="form-group">
          <input type="hidden" name="id_transaksi" value="<?php echo $id_transaksi ; ?>">
            ...
            <div class="col-md-12">
              ...
              <a href="<?php echo base_url() ; ?>transaksi/out" class="btn btn-info float-right mr-2">Cancel</a>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          <form id="form-no_bc" method="post" action="<?php echo base_url() ; ?>transaksi/out/input_no_bc">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Cutomize Qty</h5>              
              </div>
              <div class="modal-body">              
                  <div class="col-md-12">
...
<div class="modal " id="modal-form_no_bc_edit_list" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          <form id="form-no_bc_edit_list" method="post" action="<?php echo base_url() ; ?>transaksi/out/tambah/input_no_bc_edit">
              <div class="modal-header">
              ...
              <div class="modal-body">              
                  <div class="col-md-12">
                          ...
                          <div class="col-md-12 pl-4 pr-4">
                            <div class="alert alert-warning text-center row">
                              Make sure Quantity of Qty does not exceed
          ...
          <form id="form-no_bc_detail" method="post" action="<?php echo base_url() ; ?>transaksi/out/tambah/input_no_bc">
              ...
              <div class="modal-body">              
                  <div class="col-md-12">
                          ...
                          <div class="col-md-12 pl-4 pr-4">
                            <div class="alert alert-warning text-center row">
                              Make sure the Quantity of Qty does not exceed
