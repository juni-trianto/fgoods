...
class Edit extends MY_Controller {
	...
	function __construct()
	{
        ...
        $this->load->model('transaksi/in/M_edit');   
	...
	public function transaksi($id)
	{
        ...
        $data = array (
                        ...
                        'action' => base_url('transaksi/in/edit/update'),
                        'id_transaksi' => $row->id_transaksi,
                        'kode_transaksi' => $row->kode_transaksi,
                        'tanggal' => $row->tanggal,
                        'no_bc' => $row->no_bc,
                        'css' => 'content/transaksi/in/edit/css',
                        'content' => 'content/transaksi/in/edit/form',
                        'script' => 'content/transaksi/in/edit/script'
                        ) ;
