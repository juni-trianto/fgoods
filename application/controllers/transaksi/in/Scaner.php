...
class Scaner extends MY_Controller {
	...
	function __construct()
	{
        ...
        $this->load->model('transaksi/in/M_scaner');   
    ...
    public function index()
    {
        ...
        $data = array (
                        ...
                        'css' => 'content/transaksi/in/scaner/css',
                        'content' => 'content/transaksi/in/scaner/form',
                        'script' => 'content/transaksi/in/scaner/script'
    ...
    public function data_material($kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/in/scaner/data_material', $data);        
    }
    ...
    {        
        ...
        $this->load->view('content/transaksi/in/scaner/list_no_bc', $data);
    }
    ...
    public function data_no_bc($id_material)
    {
        ...
        $this->load->view('content/transaksi/in/scaner/data_no_bc', $data);
    }
    ...
    public function detail_qty()
    {
        ...
        $this->load->view('content/transaksi/in/scaner/detail_qty', $data);
    }
    ...
    public function list_transaksi($kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/in/scaner/list_transaksi', $data);
    ...
    public function edit_list_material()
    {
        ...
        $data = [
         ...
         $this->load->View('content/transaksi/in/scaner/edit_list', $data) ;
    ...
    public function list_no_bc_edit($id_material, $kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/in/scaner/list_no_bc_edit_list', $data);
    }
    ...
    public function data_no_bc_edit_list($id_material, $kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/in/scaner/data_no_bc_edit_list', $data);
    }
