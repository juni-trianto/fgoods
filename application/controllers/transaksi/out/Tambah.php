...
class Tambah extends MY_Controller {
	...
	function __construct()
	{
        ...
        $this->load->model('transaksi/out/M_tambah');   
	...
	public function index()
	{
        ...
        $data = array (
                        ...
                        'action' => base_url('transaksi/out/tambah/input'),
                        'kode_transaksi' => $kode_transaksi,
                        'id_transaksi' => '',
                        'tanggal' => set_value('tanggal'),
                        'no_bc' => set_value('no_bc'),
                        'css' => 'content/transaksi/out/tambah/css',
                        'content' => 'content/transaksi/out/tambah/form',
                        'script' => 'content/transaksi/out/tambah/script'
    ...
    public function data_material($kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/out/tambah/data_material', $data);        
    }
    ...
    {        
        ...
        $this->load->view('content/transaksi/out/tambah/list_no_bc', $data);
    }
    ...
    public function data_no_bc($kode)
    {
        ...
        $this->load->view('content/transaksi/out/tambah/data_no_bc', $data);
    }
    ...
    public function detail_qty()
    {
        ...
        $this->load->view('content/transaksi/out/tambah/detail_qty', $data);
    }
    ...
    public function list_transaksi($kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/out/tambah/list_transaksi', $data);
    ...
    public function edit_list_material()
    {
        ...
        $data = [
         ...
         $this->load->View('content/transaksi/out/tambah/edit_list', $data) ;
    ...
    public function list_no_bc_edit($kode, $kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/out/tambah/list_no_bc_edit_list', $data);
    }
    ...
    public function data_no_bc_edit_list($kode, $kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/out/tambah/data_no_bc_edit_list', $data);
    }
	...
	public function view_transaksi($kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/out/tambah/view_transaksi', $data);
