...
class Tambah extends MY_Controller {
	...
	function __construct()
	{
        ...
        $this->load->model('transaksi/ng/M_tambah');   
	...
	public function index()
	{
        ...
        $data = array (
                        ...
                        'action' => base_url('transaksi/ng/tambah/input'),
                        'kode_transaksi' => $kode_transaksi,
                        'id_transaksi' => '',
                        'tanggal' => set_value('tanggal'),
                        'no_bc' => set_value('no_bc'),
                        'css' => 'content/transaksi/ng/tambah/css',
                        'content' => 'content/transaksi/ng/tambah/form',
                        'script' => 'content/transaksi/ng/tambah/script'
    ...
    public function data_material($kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/ng/tambah/data_material', $data);        
    }
    ...
    {        
        ...
        $this->load->view('content/transaksi/ng/tambah/list_no_bc', $data);
    }
    ...
    public function data_no_bc($kode)
    {
        ...
        $this->load->view('content/transaksi/ng/tambah/data_no_bc', $data);
    }
    ...
    public function detail_qty()
    {
        ...
        $this->load->view('content/transaksi/ng/tambah/detail_qty', $data);
    }
    ...
    public function list_transaksi($kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/ng/tambah/list_transaksi', $data);
    ...
    public function edit_list_material()
    {
        ...
        $data = [
         ...
         $this->load->View('content/transaksi/ng/tambah/edit_list', $data) ;
    ...
    public function list_no_bc_edit($kode, $kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/ng/tambah/list_no_bc_edit_list', $data);
    }
    ...
    public function data_no_bc_edit_list($kode, $kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/ng/tambah/data_no_bc_edit_list', $data);
    }
