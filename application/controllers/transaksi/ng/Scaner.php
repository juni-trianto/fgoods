...
class Scaner extends MY_Controller {
	...
	function __construct()
	{
        ...
        $this->load->model('transaksi/ng/M_scaner');   
    ...
    public function index()
    {
        ...
        $data = array (
                        ...
                        'action' => base_url('transaksi/ng/scaner/input'),
                        'kode_transaksi' => $kode_transaksi,
                        'id_transaksi' => '',
                        'tanggal' => set_value('tanggal'),
                        'no_bc' => set_value('no_bc'),
                        'css' => 'content/transaksi/ng/scaner/css',
                        'content' => 'content/transaksi/ng/scaner/form',
                        'script' => 'content/transaksi/ng/scaner/script'
    ...
    public function data_material($kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/ng/scaner/data_material', $data);        
    }
    ...
    {        
        ...
        $this->load->view('content/transaksi/ng/scaner/list_no_bc', $data);
    }
    ...
    public function data_no_bc($id_material)
    {
        ...
        $this->load->view('content/transaksi/ng/scaner/data_no_bc', $data);
    }
    ...
    public function detail_qty()
    {
        ...
        $this->load->view('content/transaksi/ng/scaner/detail_qty', $data);
    }
    ...
    public function list_transaksi($kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/ng/scaner/list_transaksi', $data);
    ...
    public function edit_list_material()
    {
        ...
        $data = [
         ...
         $this->load->View('content/transaksi/ng/scaner/edit_list', $data) ;
    ...
    public function list_no_bc_edit($id_material, $kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/ng/scaner/list_no_bc_edit_list', $data);
    }
    ...
    public function data_no_bc_edit_list($id_material, $kode_transaksi)
    {
        ...
        $this->load->view('content/transaksi/ng/scaner/data_no_bc_edit_list', $data);
    }
