...
public function data_material()
    {
        return $this->db->query("
                            SELECT 
                                    ...
                                    (select sum(qty) from list_transaksi where status_transaksi = 'PO' AND list_transaksi.id_material = stok_material.id_material ) as jml_in,

                                    (select sum(qty) from list_transaksi where status_transaksi = 'IN' AND list_transaksi.id_material = stok_material.id_material ) as jml_out,

                                    (select sum(qty) from list_transaksi where status_transaksi = 'PO' AND list_transaksi.id_material = stok_material.id_material ) - 
